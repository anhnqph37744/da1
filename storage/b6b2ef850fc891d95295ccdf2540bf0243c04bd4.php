                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-5">
                            <div class="logo-area" width="200px">
                                <a href="<?php echo e(BASE_URL); ?>" class="text-decoration-none text-white fw-bold fs-4"><iconify-icon icon="ic:baseline-watch"></iconify-icon> <span class="">F-Watch</span></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-3">
                            <div class="right-blok-box text-white d-flex">
                                ...
                                <div class="shopping-cart-wrap">
                                    <a href="<?php echo e(BASE_URL . '/cart'); ?>"><i class="icon-basket-loaded"></i></span></a>
                                </div>
                                <!-- giỏ hàng nhỏ -->
...
</html><?php /**PATH C:\XAMPP\htdocs\da1\app\views/client/layouts/client-layout.blade.php ENDPATH**/ ?>